      ...
      getLayout () {
        ...
        .then((response) => {
          ...
          if ($response.code === 0) {
            ...
            this.title_page = $response.data.menus[2].title_page
            this.description_page = $response.data.menus[2].description
            this.opengraph_image = $response.data.menus[2].opengraph_image
