    ...
    export default {
      ...
      watch: {
        ...
        weight: function (newWeight, oldWeight) {
          ...
          if(oldWeight == '' || oldWeight == '0' || oldWeight == 0){
            oldWeight = String(this.weight_new)
          }
          if (newWeight == parseFloat(newWeight).toFixed(3)) {
            this.weight = oldWeight
            console.log(this.weight, oldWeight)
          }
        ...
        getLayout () {
          ...
          .then((response) => {
            ...
            if ($response.code === 0) {
              ...
              this.weight =  Number($response.data.default_weight.value)
              this.weight_new =  Number($response.data.default_weight.value)
