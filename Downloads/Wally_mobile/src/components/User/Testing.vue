<template>
  <div class="testing">
    <div class="testing-left" v-if="testInfo != null">
      <div class="box-3">
        <span>{{ $t('nomination_plan') }}</span>
        <p>{{testInfo.Plan.Name}}</p>
      </div>
      <div class="box-3">
        <span>{{ $t('nomination_theme') }}</span>
        <p>{{testInfo.Topic.Name}}</p>
      </div>
      <div class="box-3">
      ...
      <div class="box-3">
        <span>{{ $t('conditions_passage') }}</span>
        <p>>{{testInfo.PassMarks}}%</p>
      </div>
      <div class="box-3">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body">
              ...
              <router-link class="button-blue" to="/user/tests">{{ $t('ok') }}</router-link>
            </div>
          </div>
        </div>
      </div>
